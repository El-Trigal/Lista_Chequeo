...
export async function syncColdRoomRecords() {
...
export async function loadColdRoomRecords() {
  const localRecords = await syncColdRoomRecords();
...
export async function saveColdRoomRecord(record) {
...
export async function updateColdRoomRecord(record) {
...
export async function deleteColdRoomRecord(recordId) {
  const existingRecords = readLocalRecords();

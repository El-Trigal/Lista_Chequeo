...
const LOCAL_STORAGE_KEY = "cold-room-monitoring-records";
const TABLE_NAME = "cold_room_monitoring_records";
...
export async function syncColdRoomRecords(sede) {
...
export async function loadColdRoomRecords(sede) {
  const localRecords = await syncColdRoomRecords(sede);
...
export async function saveColdRoomRecord(sede, record) {
...
export async function updateColdRoomRecord(sede, record) {
...
export async function deleteColdRoomRecord(sede, recordId) {
  const existingRecords = readLocalRecords(sede);

...
export async function syncRbRootingRecords() {
...
export async function loadRbRootingRecords() {
  const localRecords = await syncRbRootingRecords();
...
export async function saveRbRootingRecord(record) {
...
export async function updateRbRootingRecord(record) {
...
export async function deleteRbRootingRecord(recordId) {
  const existingRecords = readLocalRecords();

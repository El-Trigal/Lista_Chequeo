...
const LOCAL_STORAGE_KEY = "rb-rooting-checklist-records";
const TABLE_NAME = "rb_rooting_records";
...
export async function syncRbRootingRecords(sede) {
...
export async function loadRbRootingRecords(sede) {
  const localRecords = await syncRbRootingRecords(sede);
...
export async function saveRbRootingRecord(sede, record) {
...
export async function updateRbRootingRecord(sede, record) {
...
export async function deleteRbRootingRecord(sede, recordId) {
  const existingRecords = readLocalRecords(sede);

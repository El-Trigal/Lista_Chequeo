...
export async function syncSopladoRecords() {
...
export async function loadSopladoRecords() {
  const localRecords = await syncSopladoRecords();
...
export async function saveSopladoRecord(record) {
...
export async function updateSopladoRecord(record) {
...
export async function deleteSopladoRecord(recordId) {
  const existingRecords = readLocalRecords();

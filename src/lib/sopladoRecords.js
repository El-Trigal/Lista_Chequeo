...
const LOCAL_STORAGE_KEY = "soplado-checklist-records";
const TABLE_NAME = "soplado_checklist_records";
...
export async function syncSopladoRecords(sede) {
...
export async function loadSopladoRecords(sede) {
  const localRecords = await syncSopladoRecords(sede);
...
export async function saveSopladoRecord(sede, record) {
...
export async function updateSopladoRecord(sede, record) {
...
export async function deleteSopladoRecord(sede, recordId) {
  const existingRecords = readLocalRecords(sede);

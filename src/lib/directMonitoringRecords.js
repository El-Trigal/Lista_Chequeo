...
export async function syncDirectMonitoringRecords(sede) {
...
export async function loadDirectMonitoringRecords(sede) {
  const localRecords = await syncDirectMonitoringRecords(sede);
...
export async function saveDirectMonitoringRecord(sede, record) {
...
export async function updateDirectMonitoringRecord(sede, record) {
...
export async function deleteDirectMonitoringRecord(sede, recordId) {
  const existingRecords = readLocalRecords(sede);
